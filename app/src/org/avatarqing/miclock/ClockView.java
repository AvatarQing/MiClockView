...
public class ClockView extends View {
    ...
    private float canvasMaxRotateDegree = 15;
    //最大平移斜率和最大旋转角度有关, 偏移的感觉应该是使分针指针表盘 感觉到层次，而不是单纯旋转整个平面
    private double canvasMaxTranslateSlope = Math.tan(Math.toRadians(90.0 - canvasMaxRotateDegree));
...
//		startNewSecondAnim();
    ...
    private void drawContent(Canvas canvas) {
        ...
        // Draw scale ring
        canvas.save();
        canvas.translate(canvasTranslateX * 1, canvasRotateY * 1);
        ...
        canvas.save();
        canvas.translate(canvasTranslateX * 3, canvasTranslateY * 3);
        ...
        // Draw hour pointer
        canvas.save();
        canvas.translate(canvasTranslateX * 6, canvasTranslateY * 6);
        ...
        // Draw minute pointer
        canvas.save();
        canvas.translate(canvasTranslateX * 9, canvasTranslateY * 9f);
    ...
    private void rotateCanvasWhenMove(float x, float y) {
        ...
        canvasTranslateX = (float) canvasMaxTranslateSlope * percentX;
        canvasTranslateY = (float) canvasMaxTranslateSlope * percentY;
    }
    ...
    private void initValues() {
        ...
        canvasMaxRotateDegree = 15;
        canvasMaxTranslateSlope = Math.tan(Math.toRadians(90.0 - canvasMaxRotateDegree));
        scaleTextAngle = 5;
...
//					}
    ...
    private void startNewSteadyAnim() {
        ...
        final String propertyNameTranslateX = "canvasTranslateX";
        final String propertyNameTranslateY = "canvasTranslateY";
        ...
        PropertyValuesHolder holderTranslateX = PropertyValuesHolder.ofFloat(propertyNameTranslateX, canvasTranslateX, 0);
        PropertyValuesHolder holderTranslateY = PropertyValuesHolder.ofFloat(propertyNameTranslateY, canvasTranslateY, 0);
        steadyAnim = ValueAnimator.ofPropertyValuesHolder(holderRotateX, holderRotateY, holderTranslateX, holderTranslateY);
        ...
        steadyAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                canvasTranslateX = (float) animation.getAnimatedValue(propertyNameTranslateX);
                canvasTranslateY = (float) animation.getAnimatedValue(propertyNameTranslateY);
